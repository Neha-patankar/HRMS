...
export default function MarkAttendance ({ onSelect, refresh }) {
      ...
      {!loading && employees.length > 0 && (
        <div className="">
          <table className="w-full">
            <thead>
              <tr className="border-b border-slate-200 bg-blue-950">
                <th className="text-left py-3 px-4 text-md font-bold text-white uppercase tracking-wider">Employee</th>
                <th className="text-left py-3 px-4 text-md font-bold text-white uppercase tracking-wider">Employee ID</th>
                <th className="text-left py-3 px-4 text-md font-bold text-white uppercase tracking-wider">Email</th>
                <th className="text-left py-3 px-4 text-md font-bold text-white uppercase tracking-wider">Department</th>
              
                <th className="text-right py-3 px-4 text-md font-bold text-white uppercase tracking-wider">Actions</th>
              </tr>
            </thead>
